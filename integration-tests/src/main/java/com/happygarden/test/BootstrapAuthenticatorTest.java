...
package com.happygarden.test;

import android.test.ActivityInstrumentationTestCase2;
import android.view.View;
import android.widget.Button;

import com.happygarden.authenticator.BootstrapAuthenticatorActivity;
...
public class BootstrapAuthenticatorTest extends ActivityInstrumentationTestCase2<BootstrapAuthenticatorActivity> {
    ...
    /**
     * Create test for {@link com.happygarden.authenticator.BootstrapAuthenticatorActivity}
     */
