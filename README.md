...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-happygarden.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-happygarden)

This repository contains the source code for the [Happy Garden](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.happygarden).

Please see the [issues](https://github.com.happygarden/com-happygarden/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Happy Garden? Ask away on the [com-happygarden discussion forum](https://groups.google.com/forum/#!forum/com-happygarden).

<a href="https://play.google.com/store/apps/details?id=com.happygarden" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.happygarden__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.happygarden__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.happygarden.R__) will now be renamed
...
signed with a different key.  Manually uninstall Happy Garden from your device and
...
Happy Garden is a result of a template project I've developed over the years as well as
...
Happy Garden is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.happygarden/com-happygarden/contributors) on
...
[pull requests](https://github.com.happygarden/com-happygarden/pulls).
